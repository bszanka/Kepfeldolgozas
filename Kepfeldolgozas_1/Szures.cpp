...
//
//    //a gauss szurest nem neveztuk at !!
//
//    //createTrackbar("Kernel szures: ", "Gauss szures", &kernel_size, 100, gauss_filter);
//    //gauss_filter(0, 0); // inicializaljuk
//
//    //createTrackbar("Kernel szures: ", "Gauss szures", &kernel_size, 100, mean_filter);
//    //mean_filter(0, 0); // inicializaljuk
//
//    createTrackbar("Kernel szures: ", "Gauss szures", &kernel_size, 100, median_filter);
